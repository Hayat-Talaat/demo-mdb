...
import ListGroupProPage from "../docs/pro/Components/ListGroupProPage";
import Datatable2ProPage from "../docs/pro/Tables/DataTable2Page";
...
import ColorCombination from "../docs/pro/CSS/ColorCombination";
...
import PillsPagePro from "../docs/pro/Components/PillsPage";
import SideNavPage from "../docs/pro/Navigation/SideNavPage";
import SideNav2Page from "../docs/pro/Navigation/SideNav2Page";
import SideNavPlaygroundPage from "../docs/pro/Navigation/SideNavPlaygroundPage";
...
import ScrollSpyProPage from "../docs/pro/Directives/ScrollSpyProPage";
...
import DatePicker2Page from "../docs/pro/Forms/DatePicker2Page";
import TimePickerPage from "../docs/pro/Forms/TimePickerPage";
import TimePicker2Page from "../docs/pro/Forms/TimePicker2Page";
import LightboxPage from "../docs/pro/Advanced/LightboxPage";
import MegaMenuPage from "../docs/pro/Navigation/MegaMenuPage";
import NavbarProPage from "../docs/pro/Navigation/NavbarProPage";
...
import StickyPage from "../docs/pro/Directives/StickyPage";
import FormsPagePro from "../docs/pro/Forms/FormsPage";
import StepperProPage from "../docs/pro/Components/StepperProPage";
...
import SmoothScrollPage from "../docs/pro/Directives/SmoothScrollPage";
...
import HotkeyPage from "../docs/pro/Directives/HotkeyPage";
import TouchPage from "../docs/pro/Directives/TouchPage";
import InfiniteScrollPage from "../docs/pro/Directives/InfiniteScrollPage";
import ResizePage from "../docs/pro/Directives/ResizePage";
import ClipboardPage from "../docs/pro/Directives/ClipboardPage";
import LazyLoadPage from "../docs/pro/Directives/LazyLoadPage";
import ClickOutsidePage from "../docs/pro/Directives/ClickOutsidePage";
import ScrollLockPage from "../docs/pro/Directives/ScrollLockPage";
import InputMaskPage from "../docs/pro/Directives/InputMaskPage";
import DummyPage from "../docs/pro/Directives/DummyPage";
import IntersectPage from "../docs/pro/Directives/IntersectPage";
import MutatePage from "../docs/pro/Directives/MutatePage";
import Demo from "../docs/Demo/Demo";
// /PRO
Vue.use(Router);
...
export default new Router({
  ...
  routes: [
    ...
    {
      path: "/tables/pro/datatable2",
      name: "Datatable2ProPage",
      component: Datatable2ProPage,
    },
    {
    ...
    {
      path: "/css/pro/color-combination",
    ...
    {
      path: "/directives/pro/scrollspy",
      name: "ScrollSpyProPage",
      component: ScrollSpyProPage,
    },
    {
    ...
    {
      path: "/navigation/pro/navbar",
      name: "NavbarProPage",
      component: NavbarProPage,
    },
    {
    ...
    {
      path: "/navigation/pro/sidenav2",
      name: "SideNav2Page",
      component: SideNav2Page,
    },
    {
      path: "/navigation/pro/sidenav-playground",
      name: "SideNavPlaygroundPage",
      component: SideNavPlaygroundPage,
    },
    {
      path: "/directives/pro/sticky",
      name: "Sticky",
    ...
    {
      path: "/forms/pro/timepicker2",
      name: "TimePicker2Page",
      component: TimePicker2Page,
    },
    {
    ...
    {
      path: "/components/pro/list-group",
      name: "ListGroupProPage",
      component: ListGroupProPage,
    },
    {
      path: "/directives/pro/hotkey",
      name: "HotkeyPage",
      component: HotkeyPage,
    },
    {
      path: "/directives/pro/touch",
      name: "TouchPage",
      component: TouchPage,
    },
    {
      path: "/directives/pro/infinite-scroll",
      name: "InfiniteScrollPage",
      component: InfiniteScrollPage,
    },
    {
      path: "/directives/pro/resize",
      name: "ResizePage",
      component: ResizePage,
    },
    {
      path: "/directives/pro/clipboard",
      name: "ClipboardPage",
      component: ClipboardPage,
    },
    {
      path: "/directives/pro/lazy-load",
      name: "LazyLoadPage",
      component: LazyLoadPage,
    },
    {
      path: "/directives/pro/click-outside",
      name: "ClickOutsidePage",
      component: ClickOutsidePage,
    },
    {
      path: "/directives/pro/scroll-lock",
      name: "ScrollLockPage",
      component: ScrollLockPage,
    },
    {
      path: "/directives/pro/input-mask",
      name: "InputMaskPage",
      component: InputMaskPage,
    },
    {
      path: "/directives/pro/dummy",
      name: "DummyPage",
      component: DummyPage,
    },
    {
      path: "/directives/pro/intersect",
      name: "IntersectPage",
      component: IntersectPage,
    },
    {
      path: "/directives/pro/mutate",
      name: "MutatePage",
